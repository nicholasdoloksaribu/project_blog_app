...
function createButton(title, content, command) {
  ...
  function ButtonFactory(props) {
    ...
    return import_react.default.createElement("button", __assign({ type: "button", title }, props, { className: "rsw-btn", onMouseDown: onAction, "data-active": active }), content);
  }
}
...
function createDropdown(title, items) {
  ...
  function DropdownFactory(props) {
    ...
    return import_react.default.createElement(Dropdown, __assign({}, props, { onChange, title, items, selected: activeIndex }));
...
function HtmlButton(_a) {
  ...
  return import_react.default.createElement("button", __assign({ type: "button", title: "HTML mode", className: "rsw-btn", onClick, "data-active": editorState.htmlMode }, rest), "</>");
}
function Separator() {
  var editorState = useEditorState();
  if (editorState.htmlMode) {
